...
const install = (Vue, vm) => {
	...
	vm.$u.api = {
		...
		//smartcase
		userDevice: {
			form: (params = {}) => vm.$u.post(config.adminPath+'/smartcase/userDevice/form', params),
			list: (params = {}) => vm.$u.post(config.adminPath+'/smartcase/userDevice/listData', params),
			save: (params = {}) => vm.$u.postJson(config.adminPath+'/smartcase/userDevice/save', params),
			disable: (params = {}) => vm.$u.post(config.adminPath+'/smartcase/userDevice/disable', params),
			enable: (params = {}) => vm.$u.post(config.adminPath+'/smartcase/userDevice/enable', params),
			delete: (params = {}) => vm.$u.post(config.adminPath+'/smartcase/userDevice/delete', params),
			command: (params = {}) => vm.$u.post(config.adminPath+'/smartcase/userDevice/command', params),
			// execCommand: (params = {}) => vm.$u.post(config.adminPath+'/smartcase/userDevice/execCommand', params),
		},
